...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_cancle_download = (Button) findViewById(R.id.btn_cancle_download);

        btn_start_download.setOnClickListener(this);
        btn_pause_download.setOnClickListener(this);
        btn_cancle_download.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_start_download:
                String url = "http://10.0.2.2/xmlTest/myshoe.mp4";
